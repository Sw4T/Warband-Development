...
presentations = [
  ...
  ("game_profile_banner_selection", 0, mesh.load_window, [
    (ti_on_presentation_load, [
      (set_fixed_point_multiplier, 1000),
    ...
    (ti_on_presentation_run,
     [
       ...
       (try_begin),
         ...
         (multiplayer_send_int_to_player, ":my_player_no", multiplayer_event_initialize_brawl, 0),
  ...
  ("multiplayer_item_select", prsntf_manual_end_only, 0, [
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (agent_get_item_slot, ":selected_item_id", ":agent_id", 0),
      (try_begin),
      ...
      # (player_get_slot, ":selected_item_id", ":my_player_no", ":selected_item_index"),
      (agent_get_item_slot, ":selected_item_id", ":agent_id", 1),
      (try_begin),
        (ge, ":selected_item_id", 0),
      ...
      # (player_get_slot, ":selected_item_id", ":my_player_no", ":selected_item_index"),
      (agent_get_item_slot, ":selected_item_id", ":agent_id", 2),
      (try_begin),
        (ge, ":selected_item_id", 0),
      ...
      # (player_get_slot, ":selected_item_id", ":my_player_no", ":selected_item_index"),
      (agent_get_item_slot, ":selected_item_id", ":agent_id", 3),
      (try_begin),
        (ge, ":selected_item_id", 0),
      ...
      # (player_get_slot, ":selected_item_id", ":my_player_no", ":selected_item_index"),
      (agent_get_item_slot, ":selected_item_id", ":agent_id", 4),
      (try_begin),
        (ge, ":selected_item_id", 0),
      ...
      # (player_get_slot, ":selected_item_id", ":my_player_no", ":selected_item_index"),
      (agent_get_item_slot, ":selected_item_id", ":agent_id", 5),
      (try_begin),
        (ge, ":selected_item_id", 0),
      ...
      # (player_get_slot, ":selected_item_id", ":my_player_no", ":selected_item_index"),
      (agent_get_item_slot, ":selected_item_id", ":agent_id", 6),
      (try_begin),
        (ge, ":selected_item_id", 0),
      ...
      # (player_get_slot, ":selected_item_id", ":my_player_no", ":selected_item_index"),
      (agent_get_item_slot, ":selected_item_id", ":agent_id", 7),
      (try_begin),
        (ge, ":selected_item_id", 0),
        ...
        (try_begin),
          ...
          (try_begin),
            ...
            (else_try),
              ...
              (agent_get_item_slot, ":item_no", ":agent_id", 1),
